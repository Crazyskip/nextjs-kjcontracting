  ...
  return (
    <div className="font-roboto">
      ...
      <div className="content">
        ...
        <div className="w-11/12 mx-auto flex flex-col sm:flex-row items-center my-6">
          ...
          <div className="w-full mx-auto sm:pl-8">
            ...
            <div className="font-light mb-8">
              <p className="pb-4">
                ...
                experience, including specialising in the Macadamia Industry.
                Our client base commands anything from small jobs involving tree
              ...
              <p>
                ...
                well-known throughout the Northern Rivers for delivering
                quality, timely and on-budget projects to completion. We pride
                ourselves on understanding our clients needs and ensuring that
                we deliver on our promise of satisfaction.
              </p>
            </div>
          </div>
        </div>
